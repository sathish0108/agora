...
var options = {
    appid: "9509fda992ae492e9d6ba2f776084948",
    channel: "test3",
    uid: null,
    token:  "007eJxTYHgWbrOneY+s7geLxFO22Q7CC2ql14gdOsW+Le+oq7xnxXEFBktTA8u0lERLS6PEVBNLo1TLFLOkRKM0c3MzAwsTSxMLP9a4lIZARgZ5qXJWRgYIBPFZGUpSi0uMGRgA2DgcnA==",
    accountName: null
};
...
async function RTMJoin() {
    ...
    console.log(accountName,"rrrrrrrtmmmmmmmm");
   await clientRTM.login({"uid":accountName}).then(() => {
